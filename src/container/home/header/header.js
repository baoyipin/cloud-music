...
import logo from "../../../svgs/personal-active.svg";
//创建组件
    ...
    render() {
        ...
        return (
            <div className='header'>
                <NavBar
                    leftContent={<FontAwesome key='bars' name="bars" style={{ display:"block" }}/>}
                ...
                >
                    <Flex>
                        ...
                        <Flex.Item><Link to='/'><img className='small-logo' src={logo}/></Link></Flex.Item>
